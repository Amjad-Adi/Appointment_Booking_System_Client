...
const createUserFields = {
    firstName: z.string().trim().nonempty({ error: 'First Name is required' }).max(64, {
        error: 'First Name must be at most 64 characters',
    }),

    lastName: z.string().trim().nonempty({ error: 'Last Name is required' }).max(64, {
...
export const inviteUserSchema = z
    .object({
        ...
        role: z
            ...
            .refine((role) => role !== Role.SUPER_ADMIN && role !== Role.CUSTOMER, {
...
export const queryUserSchema = querySchema
    .extend({
        ...
        sortBy: z
            .enum([SORT_BY_NAME, SORT_BY_CREATED_AT_UTC], {
