                ...
                >
                    ...
                    <div className="flex flex-col gap-3 sm:gap-4">
                        {fields.map((field) => {
                            ...
                            const validationErrorMessage = fieldError?.message
                    ...
                    <div className="mt-3 flex shrink-0 flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                        <div className="group sm:w-auto">
                            <Button
                                ...
                                className="h-8 w-full border border-[#d3d3df] bg-transparent px-3 text-[11px] font-semibold text-[#454556] hover:bg-[#ededf2] hover:text-[#343447] sm:h-8 sm:w-auto sm:px-3 sm:text-[11px]"
                            >
                                {cancelLabel}
                            </Button>
                        </div>
                        ...
                        <div className="group sm:w-auto">
                            <Button
                                type="submit"
                                disabled={isSubmitting}
                                className="h-8 w-full px-3 text-[11px] font-semibold sm:h-8 sm:w-auto sm:px-3 sm:text-[11px]"
                            >
                                {submitLabel}
                            </Button>
                        </div>
