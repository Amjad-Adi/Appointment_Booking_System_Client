...
interface ServiceViewSwitcherProps {
    value: ViewMode;
    onChange: (value: ViewMode) => void;
}
const viewOptions: ViewOption<ViewMode>[] = [
    { value: ViewMode.TABLE, label: viewModeRecord[ViewMode.TABLE], icon: Table2 },
    { value: ViewMode.GRID, label: viewModeRecord[ViewMode.GRID], icon: LayoutGrid },
];
export function ServiceViewSwitcher({ value, onChange }: ServiceViewSwitcherProps) {
